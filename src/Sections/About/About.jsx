  ...
  return (
    <section id="about">
      ...
      <Container fluid className="text-center">
        <Row>
          <h2 className='app__about-headertext'>Ab<span className='app__about-innertext'>out</span>
            <br />
            The<span className='app__about-innertext'>Gym</span></h2>
          ...
          <Col size="6" xs={6}>
            <Card className="bg-dark text-white app__about-card" >
              ...
              <Card.Body>
                ...
                <Card.Title>
                  <h2 className='app__about-headertext'>Br<span className='app__about-innertext'>anch</span>es!</h2>
